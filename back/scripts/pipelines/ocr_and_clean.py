...
Supports PDF, DOCX, HWP, and image files with OCR
"""
...
from back.scripts.chunk.semantic_splitter import HybridTextSplitter


class UniversalPipeline:
    """Universal document processing pipeline for RAG system"""
